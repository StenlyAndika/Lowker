			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h6>SELAMAT DATANG <?= strtoupper($admin['username']) ?></h6>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h6>Daftar Perusahaan yang belum di verifikasi </h6>
					</div>
	...
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h6>Daftar lowongan yang belum di verifikasi</h6>
					</div>
					<div class="card-body card-block">
						<form>
							<div class="table-responsive-lg">
							<table id="datatable" class="table table-striped table-bordered" width="100%">
								...
								<tbody>
									<?php $no=0; foreach ($lowongan as $row) : $no++; ?>
									<tr>
										<?php
